 ...
 */
    ...
    /*
    Stream() -> abre os utilitarios das listas
    filter() -> indica que será feito um filtro dos elementos da lista dentro dele indicamos qual
    o criterio
    "heroi ->" - nome daado a cada elemento na lista para podermos escrever nosso filtro
     */
